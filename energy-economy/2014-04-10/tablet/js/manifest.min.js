...
this.wrapper.offsetHeight;this.options.listenX&&(this.wrapperWidth=this.wrapper.clientWidth,this.options.resize?(this.indicatorWidth=Math.max(Math.round(this.wrapperWidth*this.wrapperWidth/(this.scroller.scrollerWidth||this.wrapperWidth||1)),8),this.indicatorStyle.width=this.indicatorWidth+"px"):this.indicatorWidth=this.indicator.clientWidth,this.maxPosX=this.wrapperWidth-this.indicatorWidth,"clip"==this.options.shrink?(this.minBoundaryX=-this.indicatorWidth+8,this.maxBoundaryX=this.wrapperWidth-8):(this.minBoundaryX=0,this.maxBoundaryX=this.maxPosX),this.sizeRatioX=this.options.speedRatioX||this.scroller.maxScrollX&&this.maxPosX/this.scroller.maxScrollX),this.options.listenY&&(this.wrapperHeight=this.wrapper.clientHeight,this.options.resize?(this.indicatorHeight=Math.max(Math.round(this.wrapperHeight*this.wrapperHeight/(this.scroller.scrollerHeight||this.wrapperHeight||1)),8),this.indicatorStyle.height=this.indicatorHeight+"px"):this.indicatorHeight=this.indicator.clientHeight,this.maxPosY=this.wrapperHeight-this.indicatorHeight,"clip"==this.options.shrink?(this.minBoundaryY=-this.indicatorHeight+8,this.maxBoundaryY=this.wrapperHeight-8):(this.minBoundaryY=0,this.maxBoundaryY=this.maxPosY),this.maxPosY=this.wrapperHeight-this.indicatorHeight,this.sizeRatioY=this.options.speedRatioY||this.scroller.maxScrollY&&this.maxPosY/this.scroller.maxScrollY),this.updatePosition()},updatePosition:function(){var x=this.options.listenX&&Math.round(this.sizeRatioX*this.scroller.x)||0,y=this.options.listenY&&Math.round(this.sizeRatioY*this.scroller.y)||0;this.options.ignoreBoundaries||(x<this.minBoundaryX?("scale"==this.options.shrink&&(this.width=Math.max(this.indicatorWidth+x,8),this.indicatorStyle.width=this.width+"px"),x=this.minBoundaryX):x>this.maxBoundaryX?"scale"==this.options.shrink?(this.width=Math.max(this.indicatorWidth-(x-this.maxPosX),8),this.indicatorStyle.width=this.width+"px",x=this.maxPosX+this.indicatorWidth-this.width):x=this.maxBoundaryX:"scale"==this.options.shrink&&this.width!=this.indicatorWidth&&(this.width=this.indicatorWidth,this.indicatorStyle.width=this.width+"px"),y<this.minBoundaryY?("scale"==this.options.shrink&&(this.height=Math.max(this.indicatorHeight+3*y,8),this.indicatorStyle.height=this.height+"px"),y=this.minBoundaryY):y>this.maxBoundaryY?"scale"==this.options.shrink?(this.height=Math.max(this.indicatorHeight-3*(y-this.maxPosY),8),this.indicatorStyle.height=this.height+"px",y=this.maxPosY+this.indicatorHeight-this.height):y=this.maxBoundaryY:"scale"==this.options.shrink&&this.height!=this.indicatorHeight&&(this.height=this.indicatorHeight,this.indicatorStyle.height=this.height+"px")),this.x=x,this.y=y,this.scroller.options.useTransform?this.indicatorStyle[utils.style.transform]="translate("+x+"px,"+y+"px)"+this.scroller.translateZ:(this.indicatorStyle.left=x+"px",this.indicatorStyle.top=y+"px")},_pos:function(x,y){0>x?x=0:x>this.maxPosX&&(x=this.maxPosX),0>y?y=0:y>this.maxPosY&&(y=this.maxPosY),x=this.options.listenX?Math.round(x/this.sizeRatioX):this.scroller.x,y=this.options.listenY?Math.round(y/this.sizeRatioY):this.scroller.y,this.scroller.scrollTo(x,y)},fade:function(val,hold){if(!hold||this.visible){clearTimeout(this.fadeTimeout),this.fadeTimeout=null;var time=val?250:500,delay=val?0:300;val=val?"1":"0",this.wrapperStyle[utils.style.transitionDuration]=time+"ms",this.fadeTimeout=setTimeout(function(val){this.wrapperStyle.opacity=val,this.visible=+val}.bind(this,val),delay)}}},IScroll.utils=utils,"undefined"!=typeof module&&module.exports?module.exports=IScroll:window.IScroll=IScroll}(window,document,Math),!function(a){var b=function(a){var b=a.backingStorePixelRatio||a.webkitBackingStorePixelRatio||a.mozBackingStorePixelRatio||a.msBackingStorePixelRatio||a.oBackingStorePixelRatio||a.backingStorePixelRatio||1;return(window.devicePixelRatio||1)/b},c=function(a,b){for(var c in a)a.hasOwnProperty(c)&&b(a[c],c)},d={fillRect:"all",clearRect:"all",strokeRect:"all",moveTo:"all",lineTo:"all",arc:[0,1,2],arcTo:"all",bezierCurveTo:"all",isPointinPath:"all",isPointinStroke:"all",quadraticCurveTo:"all",rect:"all",translate:"all",createRadialGradient:"all",createLinearGradient:"all"};c(d,function(c,d){a[d]=function(a){return function(){var d,e,f=b(this),g=Array.prototype.slice.call(arguments);if("all"===c)g=g.map(function(a){return a*f});else if(Array.isArray(c))for(d=0,e=c.length;e>d;d++)g[c[d]]*=f;return a.apply(this,g)}}(a[d])}),a.fillText=function(a){return function(){var c=b(this),d=Array.prototype.slice.call(arguments);d[1]*=c,d[2]*=c,this.font=this.font.replace(/(\d+)(px|em|rem|pt)/g,function(a,b,d){return b*c+d}),a.apply(this,d),this.font=this.font.replace(/(\d+)(px|em|rem|pt)/g,function(a,b,d){return b/c+d})}}(a.fillText),a.strokeText=function(a){return function(){var c=b(this),d=Array.prototype.slice.call(arguments);d[1]*=c,d[2]*=c,this.font=this.font.replace(/(\d+)(px|em|rem|pt)/g,function(a,b,d){return b*c+d}),a.apply(this,d),this.font=this.font.replace(/(\d+)(px|em|rem|pt)/g,function(a,b,d){return b/c+d})}}(a.strokeText)}(CanvasRenderingContext2D.prototype),function(a){a.getContext=function(a){return function(b){var c,d,e=a.call(this,b);return"2d"===b&&(c=e.backingStorePixelRatio||e.webkitBackingStorePixelRatio||e.mozBackingStorePixelRatio||e.msBackingStorePixelRatio||e.oBackingStorePixelRatio||e.backingStorePixelRatio||1,d=(window.devicePixelRatio||1)/c,d>1&&(this.style.height=this.height+"px",this.style.width=this.width+"px",this.width*=d,this.height*=d)),e}}(a.getContext)}(HTMLCanvasElement.prototype);var App=function(){var that=this,slider=null,current=0,timeouts=[],intervals=[];this.on=function(){timeouts[9]=setTimeout(function(){c1=document.getElementById("sc1"),c1.width=400,c1.height=220,ctx1=c1.getContext("2d"),that.initText1(),that.animateText1(),c2=document.getElementById("sc2"),c2.width=400,c2.height=50,ctx2=c2.getContext("2d"),c3=document.getElementById("sc3"),c3.width=400,c3.height=100,ctx3=c3.getContext("2d"),c4=document.getElementById("sc4"),c4.width=400,c4.height=100,ctx4=c4.getContext("2d")},250),slider=new IScroll("#slider",{scrollY:!1,scrollX:!0,snap:"li",momentum:!1,bounceEasing:"quadratic",deceleration:.01,click:!0}),slider.on("scrollEnd",function(){var page=current=slider.currentPage.pageX;1==page&&(that.initText2(),timeouts[0]=setTimeout(function(){$(".lines").show().addClass("bounceIn"),that.animateText2(),timeouts[0]=setTimeout(function(){$(".map-people").show().addClass("bounceIn")},250)},250)),2==page&&(that.initText3(),timeouts[1]=setTimeout(function(){$(".man").show().addClass("bounceIn"),timeouts[2]=setTimeout(function(){$(".men").show().addClass("bounceIn"),that.animateText3()},250)},250)),3==page&&(that.initText4(),timeouts[3]=setTimeout(function(){$(".slide:nth-child(4) .heading, #sc4").show().addClass("bounceIn"),timeouts[4]=setTimeout(function(){$(".cta-inner").css("display","block").addClass("bounceIn"),timeouts[5]=setTimeout(function(){that.animateText4()},500)},250)},250)),that.handleChange()}),$(".arrow-right").off().on("click",function(){3>current&&(slider.goToPage(current+1,0,250,IScroll.utils.easeIn),current++,that.handleChange())}),$(".arrow-left").off().on("click",function(){current>0&&(slider.goToPage(current-1,0,250,IScroll.utils.easeIn),current--,that.handleChange())}),$(".one").off().on("click",function(){$(".info-one").toggle()}),$(".two").off().on("click",function(){$(".info-two").toggle()}),$(".slide:nth-child(1) .heading").show().addClass("bounceInReverse")},this.off=function(){$.each(timeouts,function(i,to){clearTimeout(to)}),$.each(intervals,function(i,iv){clearTimeout(iv)}),current=0,slider.goToPage(0,0,0),slider.destroy(),slider=null,ctx1.clearRect(0,0,480,550),$(".arrow-left").hide()},this.handleChange=function(){3==current?$(".arrow-right").hide():$(".arrow-right").show(),0==current?$(".arrow-left").hide():$(".arrow-left").show(),1==current||2==current?$(".cta").show():$(".cta").hide(),$(".dot").removeClass("active"),$(".dot:nth-child("+(current+1)+")").addClass("active"),$(".info-one, .info-two").hide()},this.initText1=function(){ctx1.clearRect(36,30,150,36),ctx1.clearRect(0,65,250,36),ctx1.font="36px interstate_cond_monobold",ctx1.fillStyle="#4f4e4c",ctx1.fillText("WHICH INDUSTRY",0,30),ctx1.fillText("IS",0,65),ctx1.fillText("CREATING",36,65),ctx1.fillText("AMERICAN JOBS",0,100),ctx1.fillText("AND STRENGTHENING",0,135),ctx1.fillText("THE ECONOMY?",0,170)},this.animateText1=function(){var i=0;intervals[0]=setInterval(function(){that.changeText1(i),i++,i>=99&&(clearInterval(intervals[0]),that.changeText1(100))},5)},this.changeText1=function(i){var gradient=ctx1.createLinearGradient(0,0,390,0);gradient.addColorStop(i/100,"#009dd9"),gradient.addColorStop(i/100,"#4f4e4c"),ctx1.clearRect(36,30,150,36),ctx1.clearRect(0,65,250,36),ctx1.fillStyle=gradient,ctx1.fillText("CREATING",36,65),ctx1.fillText("AMERICAN JOBS",0,100)},this.initText2=function(){ctx2.clearRect(220,0,120,40),ctx2.font="36px interstate_cond_monobold",ctx2.fillStyle="#4f4e4c",ctx2.fillText("THE ANSWER IS",0,30),ctx2.fillText("ENERGY",220,30)},this.animateText2=function(){var i=0;intervals[1]=setInterval(function(){that.changeText2(i),i++,i>=99&&(clearInterval(intervals[1]),that.changeText2(100))},5)},this.changeText2=function(i){var gradient=ctx2.createLinearGradient(0,0,390,0);gradient.addColorStop(i/100,"#009dd9"),gradient.addColorStop(i/100,"#4f4e4c"),ctx2.clearRect(220,0,120,40),ctx2.fillStyle=gradient,ctx2.fillText("ENERGY",220,30)},this.initText3=function(){ctx3.clearRect(0,0,319,55),ctx3.font="48px interstate_cond_monobold",ctx3.fillStyle="#4f4e4c",ctx3.fillText("CREATES 3 MORE",0,51)},this.animateText3=function(){var i=0;intervals[2]=setInterval(function(){that.changeText3(i),i++,i>=99&&(clearInterval(intervals[2]),that.changeText3(100))},5)},this.changeText3=function(i){var gradient=ctx3.createLinearGradient(0,0,390,0);gradient.addColorStop(i/100,"#009dd9"),gradient.addColorStop(i/100,"#4f4e4c"),ctx3.clearRect(0,0,319,55),ctx3.fillStyle=gradient,ctx3.fillText("CREATES 3 MORE",0,51)},this.initText4=function(){ctx4.clearRect(0,0,118,35),ctx4.font="36px interstate_cond_monobold",ctx4.fillStyle="#4f4e4c",ctx4.fillText("ENERGY",0,30),ctx4.fillText("DRIVES OUR",118,30),ctx4.fillText("ECONOMY FORWARD.",0,65)},this.animateText4=function(){var i=0;intervals[3]=setInterval(function(){that.changeText4(i),i++,i>=99&&(clearInterval(intervals[3]),that.changeText4(100))},5)},this.changeText4=function(i){var gradient=ctx4.createLinearGradient(0,0,390,0);gradient.addColorStop(i/100,"#009dd9"),gradient.addColorStop(i/100,"#4f4e4c"),ctx4.clearRect(0,0,118,35),ctx4.fillStyle=gradient,ctx4.fillText("ENERGY",0,30)}};