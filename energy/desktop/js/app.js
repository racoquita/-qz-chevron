ChevronSlider = function() {
  ...
  this.reset_slide_0_with_fade = function() {
    $('#slide-1').find('img').fadeOut( 1000, that.reset_slide_0 );
  }
  this.slide_0_animation_with_automation = function() {
    $(window).on( 'mouseenter focusin', function() {
      clearTimeout( that.slide_0_automaton );
    });
    that.slide_0();
    that.slide_0_automaton = setTimeout( function() {
      that.reset_slide_0_with_fade();
      that.slide_0();
    }, 6000);
  }
  ...
  this.blinker();
  this.reset_slide_0();
  that.slide_0_animation_with_automation();
}
